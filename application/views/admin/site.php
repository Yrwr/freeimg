		...
		<div class="layui-col-lg12">
			...
			<form class="layui-form" action = "/set/site" method = "post">
				<div class="layui-form-item">
					...
					<input type="text" name="logo" required  lay-verify="required" placeholder="可输入绝对路径或URL地址，如果使用文字Logo此项不用删除。" autocomplete="off" class="layui-input" value = "<?php echo $logo; ?>">
					</div>
				</div>
              	<div class="layui-form-item">
					<label class="layui-form-label">文字Logo</label>
					<div class="layui-input-block">
					<input type="text" name="logo2" placeholder="如果使用文字Logo则图片Logo会失效；如果使用图片Logo，请保持此项为空。" autocomplete="off" class="layui-input" value = "<?php echo $logo2; ?>">
					</div>
				</div>
				<div class="layui-form-item">
